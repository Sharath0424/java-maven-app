pipeline {
    ...
    stages {
        ...
        stage('Git clone') {
            steps {
                git branch: 'main', url: 'https://github.com/Sharath0424/java-maven-app.git'
            }
        }
    ...
    always {
        script {
            ...
            emailext (
                ...
                """,
                to: 'saisharatrhgoudgoundla@gmail.com',
                from: 'saisharatrhgoudgoundla@gmail.com',
                replyTo: 'saisharatrhgoudgoundla@gmail.com',
                mimeType: 'text/html',
